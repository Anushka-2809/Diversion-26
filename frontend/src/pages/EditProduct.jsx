...
const EditProduct = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const res = await fetch(`${API_URL}/fish/${id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
        if (!res.ok) throw new Error("Failed to fetch product");
        const data = await res.json();
        const product = data.fish || data;
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-sky-50 to-slate-50">
        <Card className="max-w-md w-full mx-4">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Only registered sellers can edit products.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update the core details about your seafood product
                </CardDescription>
              </CardHeader>
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update pricing and available quantity
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Update origin and catch date details
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Replace with a new image or keep the existing one
                </CardDescription>
              </CardHeader>
              <CardContent>
                {!imagePreview ? (
                  ...
                  <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-100">
                    ...
                    <div className="absolute bottom-3 left-3">
                      <Badge className="bg-white/90 text-slate-800 hover:bg-white/90 backdrop-blur-sm">
                        {existingImage ? "Current image" : form.image?.name}
                      </Badge>
                    </div>
                  </div>
                )}
          ...
          >
            ...
            <p className="text-center text-xs text-muted-foreground mt-3">
              Changes will be reflected on the marketplace immediately.
            </p>
          </motion.div>
        </form>
      </div>
